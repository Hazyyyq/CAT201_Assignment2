...
// Ensure you have a Footer component or remove this line if not
import Footer from '../components/Footer.jsx';

function AboutPage() {
    const [isOpen, setIsOpen] = useState(false);

    // --- NEW CODE: SCROLL TO TOP ON LOAD ---
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
                ...
                <div className="All-Grid">
                    ...
                    <article className="managerProfile">
                        ...
                        <div className="info">
                            ...
                            <p className="job-desc">
                                Constructed the world logic. Ensures the database is robust enough to handle the ultimate boss fight.
                            </p>
                        </div>
                        <ul className="ManagerSocMed">
                            {/* Add your social links back here if needed */}
                    ...
                    <article className="managerProfile">
                        ...
                        <div className="info">
                            ...
                            <p className="job-desc">
                                Polished the pixels. Designed an interface that looks pleasing to the eye and fits the game's lore.
                            </p>
                        </div>
                        <ul className="ManagerSocMed">
                            ...
                            <li><a href="linkedin.com/in/aimanakmalazlan/"><i className="fa fa-linkedin-square"></i></a></li>
                        </ul>
                    </article>
                    ...
                    <article className="managerProfile">
                        ...
                        <ul className="ManagerSocMed">
                            ...
                            <li><a href="https://www.linkedin.com/in/muhammad-johan-bin-talib-moe-5426b03a3/?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"><i className="fa fa-linkedin-square"></i></a></li>
                        </ul>
                    </article>
                    ...
                    <article className="managerProfile">
                        ...
                        <div className="info">
                            ...
                            <p className="job-desc">
                                Master of execution. Squashed bugs and wrote the code that makes the buttons click and the animations flow.
                            </p>
